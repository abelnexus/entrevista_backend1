...
//       login_as: "admin", // o "student"
//     });

//     const token = res.data.token;

//     // Guarda token en sessionStorage (no se comparte entre pestañas)
//     sessionStorage.setItem("sessionToken", token);

//     // Configura axios para mandar el token por header Authorization
//     axios.defaults.headers.common["Authorization"] = `Bearer ${token}`;

//     // Obtener permisos y actualizar ability
//     const userRes = await axios.get("/api/user");
//     const userAbilities = userRes.data.ability || [];
//     sessionStorage.setItem("userData", JSON.stringify({ ability: userAbilities }));
    ...
    >
      <VCard flat :max-width="500" class="mt-12 mt-sm-0 pa-4">
        <VCardText>
          ...
          <h5 class="text-h5 mb-1">entrevista backend 1</h5>

          <p class="mb-0">Login para administradores</p>
        </VCardText>
